...
exports.upload = multer({
    storage: multerS3({
        ...
        key: function (req, file, cb) {
            ...
            logger.info(`S3 object uploaded successfully`, {tags: 'http', additionalInfo: {fileDetails: file }});
        }
    })
});
...
exports.deleteS3Object = function(bookImage){
    s3.deleteObject({
        ...
        else logger.info(`S3 object deleted successfully`, {tags: 'http', additionalInfo: {fileDetails: data }});                // deleted
    });    
}
